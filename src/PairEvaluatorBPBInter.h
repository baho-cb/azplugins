...
#ifndef AZPLUGINS_PAIR_EVALUATOR_BPBINTER_H_
#define AZPLUGINS_PAIR_EVALUATOR_BPBINTER_H_
...
struct PairParametersBPBInter : public PairParameters
    {
#ifndef __HIPCC__
    PairParametersBPBInter() : epsilon(0) { }

    PairParametersBPBInter(pybind11::dict v, bool managed = false)
        {
 ...
 * Scalar.
 */
class PairEvaluatorBPBInter : public PairEvaluator
    {
    public:
    //! Define the parameter type used by this pair potential evaluator
    typedef PairParametersBPBInter param_type;
     ...
     */
    DEVICE PairEvaluatorBPBInter(Scalar _rsq, Scalar _rcutsq, const param_type& _params)
...
#endif // AZPLUGINS_PAIR_EVALUATOR_BPBINTER_H_
