...
#ifndef AZPLUGINS_PAIR_EVALUATOR_BPBTAIL_H_
#define AZPLUGINS_PAIR_EVALUATOR_BPBTAIL_H_
...
struct PairParametersBPBTail : public PairParameters
    {
#ifndef __HIPCC__
    PairParametersBPBTail() : epsilon(0) { }

    PairParametersBPBTail(pybind11::dict v, bool managed = false)
        {
 ...
 * Scalar.
 */
class PairEvaluatorBPBTail : public PairEvaluator
    {
    public:
    //! Define the parameter type used by this pair potential evaluator
    typedef PairParametersBPBTail param_type;
     ...
     */
    DEVICE PairEvaluatorBPBTail(Scalar _rsq, Scalar _rcutsq, const param_type& _params)
...
#endif // AZPLUGINS_PAIR_EVALUATOR_BPBTAIL_H_
